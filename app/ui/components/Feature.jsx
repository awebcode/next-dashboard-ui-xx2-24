      ...
      <Container>
        <div className="max-w-2xl mx-auto lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-lg text-gray-400">
            Olivia was built for investors like you who play by their own rules and are
            not going to let SEC regulations get in the way of their dreams. If other
            investing tools are afraid to build it, Olivia has it.
          </p>
        </div>
      </Container>
      {/* Desktop View */}
