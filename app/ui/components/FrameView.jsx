            ...
            <div key={stock.name} className="flex items-center gap-4 px-4 py-3">
              ...
              <div className="flex-none text-right">
                ...
                <div
                  className={clsx(
                    "text-xs leading-5",
                    stock.change.startsWith("+") ? "text-blue-600" : "text-gray-500"
                  )}
                >
                  {stock.change}
                </div>
...
export const features = [
  {
    ...
    description:
      "For every friend you invite to Olivia, you get insider notifications 5 seconds sooner. And it is 10 seconds if you invite an insider.",
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
